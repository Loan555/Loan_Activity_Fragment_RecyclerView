...
class MenuFragment : Fragment() {
    ...
    private var adapterUseViewType: MenuAdapter = MenuAdapter(listData1, listData2, listData3,listData4)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recycler_view_type_menu.layoutManager = LinearLayoutManager(this.context, LinearLayoutManager.VERTICAL, false)
    }
